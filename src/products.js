const products = [
    {
      ...
      image: window.location.origin + '/images/boatHeadfone.jpg',
    ...
    },
    {
      ...
      image: window.location.origin + '/images/micromaxInB.jpg',
      description:
    ...
    },
    {
      ...
      image: window.location.origin + '/images/camera.jpg',
      description:
    ...
    },
    {
      ...
      image: window.location.origin + '/images/playstation.jpg',
      description:
    ...
    },
    {
      ...
      image: window.location.origin + '/images/mouse.jpg',
      description:
    ...
    },
    {
      ...
      image: window.location.origin + '/images/alexa.jpg',
      description:
